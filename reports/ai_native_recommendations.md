# Recomendaciones AI-Native — 2026-06-29 03:41
...
- [P0] Cobranza GEN+ (GEN+) → Cobranzas Agent · proceso score 60
- [P0] Gestión de Evento (Summit) (AECODE) → Sponsors Agent · proceso score 60
- [P0] Coordinación Académica + Postventa (AECODE) → Training Operations Agent · proceso score 54
- [P0] Ventas B2C Training (AECODE) → Ventas B2C Agent · proceso score 53
- [P0] Control de Alcance BIM (GEN+) → Control de Alcance BIM Agent · proceso score 46
- [P0] Implementación en Obra (VisionPro) → Demo / Deployment Agent · proceso score 40
- [P1] Knowledge OS / Context Pipeline (AP) → Vault Intelligence Agent · proceso score 68
- [P1] Lanzamiento / Pre Congreso (AECODE) → Marketing Attribution Agent · proceso score 49
- [P1] Migración de Workflows (AgentFlow) → Workflow Migration Agent · proceso score 46
- [P2] Creación de Curso / Producto (AECODE) → Producto Digital / Testing Agent · proceso score 55
- [P2] Ventas B2B (GEN+) → Comercial B2B Agent · proceso score 53
- [P2] Postulación a Startup (AECODE) → Startup / Convocatorias Agent · proceso score 40
